                    ...
                    <div class="card h-100">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                <asp:HyperLink ID="hlink_gotexam" runat="server" CssClass="btn btn-primary" ForeColor="White" NavigateUrl='<%# "/onlinexamsystem/question.aspx?eid=" + Eval("exam_id")%>'>Take exam</asp:HyperLink>
                            </li>
                        </ul>
                    </div>
                </div>
