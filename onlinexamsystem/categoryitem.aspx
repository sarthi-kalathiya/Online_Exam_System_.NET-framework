                ...
                <div class="col-lg-3 mb-3">
                    <div class="card h-100 text-center">
                        ...
                        <div class="card-footer">
                            <asp:HyperLink ID="btn_category" runat="server" CssClass="btn btn-primary" ForeColor="White" NavigateUrl='<%# "/onlinexamsystem/subjectexam.aspx?sid=" +  Eval("subject_id") %>'>Go to exams</asp:HyperLink>
                        </div>
                    </div>
                </div>
            </ItemTemplate>
