            ...
            using (SqlConnection con = new SqlConnection(s))
            {
                ...
                try
                {
                    ...
                    if (i > 0)
                    {
                        ...
                        Response.Redirect("/onlinexamsystem/admin/category.aspx");
                ...
                catch(Exception ex)
                {
                    txt_category.Focus();
                    panel_addcategory_warning.Visible = true;
                    lbl_categoryaddwarning.Text = "Something went wrong. Please try after sometime later</br>" + ex.Message;
                }
    ...
    public void categorylistmethod()
    {
        using(SqlConnection con = new SqlConnection(s)){
            ...
            catch(Exception ex)
            {
                ...
                lbl_categorylistwarning.Text = "Something went wrong. Please try after sometime later</br>" + ex.Message;
            }
        }
    }
