                            ...
                            <asp:GridView ID="grdview_examlist" runat="server" GridLines="None" CssClass="table table-bordered" AutoGenerateColumns="False" OnRowCommand="grdview_examlist_RowCommand" AllowPaging="True" OnPageIndexChanging="grdview_examlist_PageIndexChanging" PageSize="5">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Options">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="btn_detailsexam" runat="server" CssClass="btn" BackColor="#343A40" BorderStyle="None" ForeColor="White" NavigateUrl='<%# "/onlinexamsystem/admin/examdetails.aspx?eid=" + Eval("exam_id") %>'>
                                            <i class="fa fa-info-circle" aria-hidden="true"></i> Details
                                            </asp:HyperLink>
                                            <asp:HyperLink ID="btn_editexam" runat="server" CssClass="btn" BackColor="#343A40" BorderStyle="None" ForeColor="White" NavigateUrl='<%# "/onlinexamsystem/admin/editexam.aspx?eid=" + Eval("exam_id") %>'>
                                            ...
                                            <asp:HyperLink ID="btn_addquestion" runat="server" CssClass="btn" BackColor="#343A40" BorderStyle="None" ForeColor="White" NavigateUrl='<%# "/onlinexamsystem/admin/addquestion.aspx?eid=" + Eval("exam_id") %>'>
                                            <i class="fa fa-plus" aria-hidden="true"></i> Add Question
                                            </asp:HyperLink>
                                            <asp:HyperLink ID="btn_viewquestion" runat="server" CssClass="btn" BackColor="#343A40" BorderStyle="None" ForeColor="White" NavigateUrl='<%# "/onlinexamsystem/admin/examquestion.aspx?eid=" + Eval("exam_id") %>'>
