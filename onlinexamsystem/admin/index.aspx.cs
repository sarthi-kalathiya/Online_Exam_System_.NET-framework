...
public partial class admin_Index : System.Web.UI.Page
{
    ...
    string s = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString; //calling the connection string
    ...
    public void gettotalexam()
    {
        using (SqlConnection con = new SqlConnection(s))
        {
            ...
            catch (Exception ex)
            {
                ...
                lbl_indexwarning.Text = "Something went wrong. Please try after sometime later</br>" + ex.Message;
            }
        }
    }
