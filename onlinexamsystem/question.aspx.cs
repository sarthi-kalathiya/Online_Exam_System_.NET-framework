...
public partial class exam : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("/onlinexamsystem/login.aspx");
        }
    ...
    public void questionistmethod(int id)
    {
        using (SqlConnection con = new SqlConnection(s))
        {
            ...
            {
                panel_questshow_warning.Visible = true;
                lbl_questshowwarning.Text = "Something went wrong." + ex.Message;
            }
        }
    }
    ...
    public void checkanwer(string qid)
    {
        using (SqlConnection con = new SqlConnection(s))
        {
            ...
            {
                panel_questshow_warning.Visible = true;
                lbl_questshowwarning.Text = "Something went wrong. Please try after sometime later</br> " + ex.Message;
            }
        }
    }
    ...
    public void saveinresult(string status, int score, int tquestion)
    {
        ...
        using (SqlConnection con = new SqlConnection(s))
        {
            ...
            try
            {
                con.Open();
                cmd.ExecuteNonQuery();
                Response.Redirect("/onlinexamsystem/index.aspx");
            }
            catch (Exception ex)
            {
                panel_questshow_warning.Visible = true;
